...
export const ui = {
  ko: {
    ...
    'changelog.metaTitle': '변경이력 — Wake',
    'changelog.metaDescription':
      'Wake의 버전별 변경 내역. 새 기능·개선·버그 수정을 한 페이지에서 확인하세요.',
    'changelog.title': '변경이력',
    'changelog.lede': 'Wake의 모든 릴리스와, 그 안에서 무엇이 달라졌는지.',
    'changelog.latest': '최신',
    'changelog.viewRelease': 'GitHub 릴리스',
  ...
  en: {
    ...
    'changelog.metaTitle': 'Changelog — Wake',
    'changelog.metaDescription':
      'Every Wake release in one place — new features, improvements, and fixes.',
    'changelog.title': 'Changelog',
    'changelog.lede': 'Every Wake release, and what changed in it.',
    'changelog.latest': 'Latest',
    'changelog.viewRelease': 'GitHub release',
