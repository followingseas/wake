...
const ko = {
  ...
  'sidebar.contentSearch': '대화 내용 검색 (⌘⇧F)',
  'search.placeholder': '모든 대화 내용에서 검색',
  'search.close': '닫기',
  'search.hint': '기억나는 단어를 입력하세요. 모든 프로젝트의 대화 본문을 찾습니다.',
...
const en: Record<MessageKey, string> = {
  ...
  'sidebar.contentSearch': 'Search message contents (⌘⇧F)',
  'search.placeholder': 'Search across all conversations',
  'search.close': 'Close',
  'search.hint': 'Type a word you remember. Wake searches message contents across every project.',
  ...
  'empty.hint': '⌘F to filter sessions · ⌘⇧F to search contents',
